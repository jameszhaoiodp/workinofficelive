...
export class Dashboard2Component implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    const obs = new ResizeObserver(entries => {
      ...
      let imageSVGContainer = document.getElementById("resize-horizontal-svg")
      let width2 = imageSVGContainer?.offsetWidth || 0;
      let height2 = imageSVGContainer?.offsetHeight || 0;
      ...
      if (this.imageHeight) {
        ...
        //todo--------reset y position, will move image up and down --------------------------------------------
        console.log('dragPositionImage.y: ' + this.dragPositionImage.y);
        // this.dragPositionImage.y = this.dragPositionImage.y + 10;
        // this.dragPositionImage = {x: 0, y: this.dragPositionImage.y};
      }
